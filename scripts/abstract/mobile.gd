...
## A mob may exist in any one of the following states:[br]
## - Attack[br]
## - Death[br]
## - Hurt[br]
## - Idle[br]
...
signal state_changed(to_state: Mobile.State)
...
@abstract func _on_state_changed(to_state: Mobile.State) -> void
